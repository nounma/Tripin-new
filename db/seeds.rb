...
challenge6 = Challenge.create!(title: "Question 6", description: "trouve la rep", address: "180 avenue de floréal 1180 Belgium", score: 10, good_answer: nil, bad_answers: nil, hint: nil, input_type: "picture", picture: "default.png", cost: 1, gift: "Promo code 13", city_id: brussels.id)
