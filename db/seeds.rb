...
challenge4 = Challenge.create!(title: "Question 4", description: "Find thelkjhgf answer !", address: "170 avenue de galaxie 1180 Belgium", score: 20, good_answer: nil, bad_answers: nil, hint: "start with P", input_type: "picture", picture: "", cost: 5, gift: "Promo code 14", city_id: brussels.id)
